...
* **step1 generate ligand topology and force field information by acpype**:
  * input:
    * ligand: XXXX_ligand.mol2
  * output:
...
* **step3 organize input files for md system building**:
...
download pdbbind_amber_gromacs

```bash
cd pdbbind_amber_gromacs/mdbuild.bak
